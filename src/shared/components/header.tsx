        ...
        <header className="w-full border-b border-borda bg-white">
            <div className="max-w-7xl mx-auto flex items-center justify-between px-6 h-14">
                ...
                <div className="relative w-full max-w-md">
                    ...
                    focus:outline-none focus:ring-2 focus:ring-destaque-suave  " 
                ...
                <div className="flex items-center gap-6 pr-6">
                    ...
                    <Link href="/login">
                        <FiUser className="text-cor-primaria text-2xl cursor-pointer hover:scale-105 active:scale-95 transition-all duration-200" />
                    </Link>
                    <Link href="/carrinho">
                        <IoCartOutline className="text-cor-primaria text-2xl cursor-pointer hover:scale-105 active:scale-95 transition-all duration-200" />
                    </Link>
                </div>  
